    ...
    <form method="post" enctype="multipart/form-data" id="quickForm">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('messages.related-link') }} - สร้างรายการใหม่</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" autofocus placeholder="ชื่อภาษาไทย" name="name_th" required>
                            @error('name_th')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" autofocus placeholder="ชื่อภาษาอังกฤษ" name="name_en" required>
                            @error('name_en')
                                <small class="form-text color-red">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" autofocus placeholder="Link" name="url" required>
                            @error('url')
                                <small class="form-text color-red">{{ $message }}</small>
                            @enderror
                        </div>
