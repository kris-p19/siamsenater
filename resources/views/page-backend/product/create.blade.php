                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="group_name_th" autofocus placeholder="ชื่อกลุ่มสินค้าภาษาไทย">
                        </div>
                        <div class="form-group">
                            <label>ชื่อสินค้าภาษาไทย</label>
                            <input type="text" class="form-control" name="name_th" autofocus placeholder="ชื่อสินค้าภาษาไทย">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="group_name_en" autofocus placeholder="ชื่อกลุ่มสินค้าภาษาอังกฤษ">
                        </div>
                        <div class="form-group">
                            <label>ชื่อสินค้าภาษาอังกฤษ</label>
                            <input type="text" class="form-control" name="name_en" autofocus placeholder="ชื่อสินค้าภาษาอังกฤษ">
                        </div>
                        <div class="form-group">
