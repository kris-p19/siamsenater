    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('messages.supplier-meeting') }} - สร้างรายการใหม่</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title_th" value="{{ old('title_th') }}" autofocus placeholder="ชื่อภาษาไทย">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>ชื่ออังกฤษ</label>
                            <input type="text" class="form-control" name="title_en" value="{{ old('title_en') }}" autofocus placeholder="ชื่ออังกฤษ">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
