    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('messages.about-us') }} - สร้างรายการใหม่</h3>
                <a style="border-radius:45px;margin-left:10px;" href="{{ url('/webadmin/about-us/item/'.$about_us_id) }}" class="btn btn-default btn-sm float-right"><i class="ion-arrow-left-b"></i> ย้อนกลับ</a>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" autofocus placeholder="ชื่อภาษาอังกฤษ" name="subject_en">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>ชื่อภาษาไทย</label>
                            <input type="text" class="form-control" autofocus placeholder="ชื่อภาษาไทย" name="subject_th">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
