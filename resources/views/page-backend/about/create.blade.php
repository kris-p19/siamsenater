        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" autofocus placeholder="ชื่อหมวดภาษาอังกฤษ" name="subject_en">
                </div>
                <div class="form-group">
                    <label>ชื่อหมวดภาษาไทย</label>
                    <input type="text" class="form-control" autofocus placeholder="ชื่อหมวดภาษาไทย" name="subject_th">
                </div>
                <div class="form-group">
                    <label>URL</label>
